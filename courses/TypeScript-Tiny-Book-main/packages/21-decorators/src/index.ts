...
console.log("21-decorators is ready!");
...
console.log("internal-metadata-paramTypes:", paramTypes);
// [Function: Number]
const returnTypes = Reflect.getMetadata("design:returntype", foo, "add");
console.log("internal-metadata-returnTypes:", returnTypes);
// [Function: String]
const type = Reflect.getMetadata("design:type", foo, "name");
console.log("internal-metadata-type:", type);

console.log("Foo:", Reflect.getMetadata("design:type", Foo));
class Bar {
  @DefineType(Foo)
  prop!: Foo;
}
